...
class CpfCnpjValidator extends ConstraintValidator
{
    ...
    protected string $messageException = 'Validation for CPF or CNPJ expects a valid value';
     ...
     * @return bool
     */
    protected function maskValidador(string $value, CpfCnpj $constraint): bool
    {
     ...
     * @return bool
     */
    protected function validador(string $value, CpfCnpj $constraint): bool
    {
        ...
        for ($i = 0; $i <= 9; $i++) {
            $repetidos = str_pad('', strlen($value), (string) $i);
            if ($value === $repetidos) {
                return false;
            }
        }
